(() => {
  ...
  const EVOLUTION_URL='https://www.meteoeradar.it/radar-meteo?center=41.76,12&zoom=5.04&layer=wr';

  function openEvolution(){
    window.open(EVOLUTION_URL,'_blank','noopener,noreferrer');
  }
  ...
  $('evolutionTab').addEventListener('click',()=>{ selectMode('evolution'); openEvolution(); });
})();